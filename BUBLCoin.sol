...
contract BublCoin is ERC20, Ownable {
    ...
    uint128 public minTokensBeforeSwap = 1000 * 10**6 * 10**9; // 1 b
    ...
    uint32 public _promotionFee = 70;
    uint32 public _devFee = 20;
    uint32 public _burnFee = 5;
    uint32 public liquidityFee = 5;
    // Base adjustment decrements by subsequent var
    // until 0 is reached
    uint32 public _baseAdjustmentFee = 0; // do not set this too high as the slippage will be a problem
    uint32 public _decrementFeeAdjustmentFee = 0; 
    ...
    bool public _adjustmentFeeEnabled = false;
    ...
    constructor(
        ...
        // REALV2: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        _devWallet = 0x2F6986182bCf9AF5D4864bDA3C5b6D3A9A821a45;
        // promotion fee goes to charity
        _promotionWallet = 0x1A791291ea4Fb31DC2b1488f450a426634752b57; 
